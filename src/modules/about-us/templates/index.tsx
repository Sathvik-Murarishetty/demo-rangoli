        ...
        <div className="max-w-6xl w-full px-4">
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex justify-between gap-x-15 py-10">
                ...
                <img src="https://res.cloudinary.com/dg0rdc0bd/image/upload/v1713605625/google_nfm7g3.svg" alt="Brand 4" className="w-auto h-10" />
              </div>
            </div>
        </div>
    )
