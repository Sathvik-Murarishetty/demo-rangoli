...
<section style={{ position: 'relative', width: '80%', height: 'auto', overflow: 'hidden', marginBottom: '20px', margin: '0 auto', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  ...
  <div className="grid w-full px-20 pt-10 rounded-lg md:grid-cols-2 lg:grid-cols-4 items-center justify-center gap-5">
      <div className="flex flex-col bg-orange-50 text-white items-center gap-1.5 text-center border border-gray-200 rounded-md px-4 py-2 md:px-6 md:gap-4 md:gap-1.5 md:rounded-lg md:border">
        <div className="text-sm text-white font-medium">Delicious Dinners</div>
        <div className="text-lg text-white font-semibold">5245 +</div>
      </div>
      <div className="flex flex-col bg-orange-50 text-white items-center gap-1.5 text-center border border-gray-200 rounded-md px-4 py-2 md:px-6 md:gap-4 md:gap-1.5 md:rounded-lg md:border">
        <div className="text-sm text-white font-medium">Experienced Chef</div>
        <div className="text-lg text-white font-semibold">60 +</div>
      </div>
      <div className="flex flex-col bg-orange-50 text-white items-center gap-1.5 text-center border border-gray-200 rounded-md px-4 py-2 md:px-6 md:gap-4 md:gap-1.5 md:rounded-lg md:border">
        <div className="text-sm text-white font-medium">Our Awards</div>
        <div className="text-lg text-white font-semibold">1359 +</div>
      </div>
      <div className="flex flex-col bg-orange-50 text-white items-center gap-1.5 text-center border border-gray-200 rounded-md px-4 py-2 md:px-6 md:gap-4 md:gap-1.5 md:rounded-lg md:border">
        <div className="text-sm text-white font-medium">Happy Customers</div>
        <div className="text-lg text-white font-semibold">6560 +</div>
      </div>
    </div>
