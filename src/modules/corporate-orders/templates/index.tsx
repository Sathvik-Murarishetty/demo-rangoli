...
const Corporateorder = () => {
    ...
    <div class="grid grid-cols-2 gap-8">
        <div class="max-w-sm">
            <img src="https://res.cloudinary.com/dg0rdc0bd/image/upload/v1713609643/send_uo6ose.png" alt="Image 1" class="w-auto h-20" />
            <h2 class="text-2xl font-bold mt-4">1. SUBMIT YOUR SPECIFICATIONS</h2>
            <p class="mt-2 text-lg text-gray-700"> Provide us with details including the quantity, size, color, and type of packaging required for your gift hampers.</p>
        </div>
        <!-- Grid Item 2 -->
        <div class="max-w-sm">
            <img src="https://res.cloudinary.com/dg0rdc0bd/image/upload/v1713609643/quote_sumpay.png" alt="Image 2" class="w-auto h-20" />
            <h2 class="text-2xl font-bold mt-4">2. RECEIVE A CUSTOM QUOTE</h2>
            <p class="mt-2 text-lg text-gray-700">We will review your specifications and respond promptly with a personalized quote.</p>
        </div>
        <!-- Grid Item 3 -->
        <div class="max-w-sm">
            <img src="https://res.cloudinary.com/dg0rdc0bd/image/upload/v1713609642/order-place_gs1idy.png" alt="Image 3" class="w-auto h-20" />
            <h2 class="text-2xl font-bold mt-4">3. CONFIRM YOUR ORDER</h2>
            <p class="mt-2 text-lg text-gray-700">Once you are satisfied with the details and the quote, confirm your order to proceed.</p>
        </div>
        <!-- Grid Item 4 -->
        <div class="max-w-sm">
            <img src="https://res.cloudinary.com/dg0rdc0bd/image/upload/v1713609642/box_jyk32c.png" alt="Image 4" class="w-auto h-20" />
            <h2 class="text-2xl font-bold mt-4">4. HASSLE-FREE DELIVERY</h2>
            <p class="mt-2 text-lg text-gray-700">Your gift hampers will be delivered directly to you or to your specified recipients, anywhere without limitations.</p>
        </div>
    </div>
</div>
